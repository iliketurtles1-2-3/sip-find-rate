...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen relative flex flex-col">
      <div
        className="fixed inset-0 bg-cover bg-[center_top] bg-no-repeat -z-10"
        style={{ backgroundImage: `url(${vineyardBg})` }} />
      
      <div className="fixed inset-x-0 top-[55%] bottom-0 bg-background -z-10" />
      <div className="fixed inset-x-0 top-[45%] h-[15%] bg-gradient-to-b from-transparent to-background -z-10" />
